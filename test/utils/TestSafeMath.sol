...
contract TestSafeMathMock {
    ...
    function mult(uint256 a, uint256 b) external returns (uint256) {
        return a.mult(b);
    }
    ...
    function multdiv(uint256 a, uint256 b, uint256 c) external returns (uint256) {
        return a.multdiv(b, c);
    }

    function divCeil(uint256 a, uint256 b) external returns (uint256) {
        return a.divCeil(b);
    }
}
...
contract TestSafeMath is TestSafeMathMock {
    ...
    function testDivCeil() external {
        Assert.equal(uint256(0).divCeil(3), 0, "");
        Assert.equal(uint256(20).divCeil(3), 7, "");
